...
public class Hdf5DataSetReaderTest {
    ...
    public String filename = "src/test/resources/test.h5";
    ...
    public static void tearDownClass() {
         ...
         new File("src/test/resources/chocolate.h5").delete();
         new File("src/test/resources/chocolateARGB.h5").delete();
    ...
    public void testWriteHDF5Positive() throws Exception{
       String filename_HDF5 ="src/test/resources/chocolate.h5";
    ...
    public void testWriteHDF5Negative() throws Exception{
       String filename_HDF5 ="src/test/resources/chocolateARGB.h5";
       String filename_JPG="src/test/resources/chocolate21.jpg";
       DatasetIOService datasetIOService = context.getService(DatasetIOService.class);
